...
public class MySQL extends Database {
     ...
     */
    public MySQL(final H1Plugin plugin, final String hostname, final String port, final String database, final String username, final String password) {
        super(plugin);
    ...
    public Connection openConnection() {
        ...
        try {
            ...
            LogUtil.warn("MySQL says: " + e.getMessage());
        }
        return connection;
    }
}
